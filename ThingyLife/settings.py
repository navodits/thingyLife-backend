"""
Django settings for ThingyLife project.
...
SECRET_KEY = '=!q=#zi6yf&!1lzj@w%#8^f-ck2a@x^755%#t5(no&q&p^&tsy'
...
WSGI_APPLICATION = 'ThingyLife.wsgi.application'
